...
// Modificadores personalizados para avatares
...
// MARK: - Extensiones de ViewModifier
...
extension View {
    ...
    func avatarPulse() -> some View {
        modifier(AvatarPulse())
    }
    
    func avatarSelection(isSelected: Bool) -> some View {
        modifier(AvatarSelection(isSelected: isSelected))
    }
}
